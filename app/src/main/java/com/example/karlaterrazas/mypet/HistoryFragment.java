...
//    private String getAllContactsURL = "http://172.16.6.192/agenda_rest/webservices/getAllContacts.php";
...
//
//        lv_contacts_list = (ListView) rootView.findViewById(R.id.lv_history_list);
